# -*- coding: utf-8 -*-
"""
Created on Thu Feb 20 11:28:17 2020
...
def output():
    ...
    for k in range(0,len(df)):
        ...
        if T[0]==0:
            ...
            Dic_Mis={"time" :t, "IMEI" : T[0], "IMSI" : T[1]}
        ...
        if T not in Dict:
            ...
            for items in Dict:
                ...
                if T[0]!=0 and T[0] in items:
                    ...
                    S_Dic = { "Use Case": "UC2B","detect-time" :str(t) , "IMEI" :str(K) , "IMSI" :str(V) , "Previous IMSI" : PIMSI }
                    alert.append(S_Dic)
                    u=u+1
                    with open(r"share/alerts/{}-UC2B.json".format(datetime.datetime.now().strftime("%Y-%m-%d.%H.%M.%S.%f")),"w") as outfile:
